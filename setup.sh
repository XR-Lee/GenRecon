...
if [ "$BASIC" = true ] ; then
    pip install imageio imageio-ffmpeg tqdm easydict opencv-python-headless openexr==3.4.14 ninja trimesh transformers==4.57.3 gradio==6.0.1 tensorboard pandas lpips zstandard
